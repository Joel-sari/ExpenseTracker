...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex">
      <div className="w-screen h-screen md:w-[60v] px-12 pt-8 pb-12">
      ...
      <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative ">
        ...
        <img
          src={Card2}
          className="w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue400/15"
        />
      </div>
    </div>
  );
...
const StatsInfoCard = ({ icon, label, value, color }) => {
  return (
    <div className="flex gap-6 bg-white p-4 rounded-xl shadow-md shadow-purple400/10 border border-gray-200/50 z-10">
      <div
